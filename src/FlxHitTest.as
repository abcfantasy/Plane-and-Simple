...
{ 
	...
	{
		public static function complexHitTestObject( target1:B2FlxSprite, target2:Bitmap,  accurracy:Number = 1 ):Boolean
		{
			var bitmap1:Bitmap = flxspriteToBitmap(target1);
			//var bitmap2:Bitmap = new Bitmap(target2.bitmapData);
		...
		{
			var bitmapData:BitmapData = new BitmapData( 30, 30, true, 0x00FFFFFF );
			bitmapData.copyPixels( Graphic.pixels, new Rectangle( 0, 0, 30, 30 ), new Point( 0, 0 ) );
